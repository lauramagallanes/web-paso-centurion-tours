#!/usr/bin/env python3
"""
Script simplificado para inicializar la base de datos PostgreSQL con usuario admin
"""
...
def init_database():
    ...
    # Configuración de conexión (contraseña correcta y SSL)
    DB_CONFIG = {
        'host': 'tinambu-db-dev.cwd08asyq2vx.us-east-1.rds.amazonaws.com',
        'port': 5432,
        'database': 'tinambu_tours',
        'user': 'tinambu_admin',
        'password': 'IS3(P5i->n3-w#Qs',  # Contraseña correcta
        'sslmode': 'require'  # SSL requerido para RDS
    }
